// @ts-nocheck
// components/blog/TechBlogClient.tsx
// Extracted client component — holds all state/data-fetching logic for the Tech Blog page.
'use client';
    ...
    <Box sx={{ py: { xs: 8, md: 12 }, minHeight: '100vh' }}>
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', mb: { xs: 8, md: 10 } }}>
          ...
          <Typography
            variant="h1"
            sx={{ fontWeight: 900, fontSize: { xs: '2.5rem', sm: '3.25rem', md: '4rem' }, lineHeight: 1.1, mb: 2.5 }}
          >
        ...
        <Box sx={{ mb: 6, display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, alignItems: 'center', gap: 2 }}>
          <TextField
            ...
            sx={{ maxWidth: { sm: 480 }, mx: 'auto', '& .MuiOutlinedInput-root': { borderRadius: 3 } }}
            slotProps={{
              input: {
                startAdornment: (
